...
/**
 * This is the model class for Company Category Form.
 * 
...
class CompanyCategoryForm extends CFormModel {
    ...
    public function checkCategory($attribute, $params) {
        ...
        if (!empty($this->domain_id)) {
            $category = CompanyCats::model()->findByPk($this->domain_id);
    ...
    public function checkSubcategory($attribute, $params) {
        ...
        if (!empty($this->category_id)) {
            $category = CompanyCats::model()->findByPk($this->category_id);
            $children = $category->children()->findAll();
