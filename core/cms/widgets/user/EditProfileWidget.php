...
class EditProfileWidget extends CWidget {
    ...
    protected function renderContent() {
        ...
        if (!user()->isGuest) {
            ...
            $profile = UserProfile::model()->find(array('condition' => 'userId=:userId', 'params' => array(':userId' => $user->user_id)));
            ...
            $this->render('cmswidgets.views.user.edit_profile_widget', array('model' => $model, 'user' => $user));
        } else {
