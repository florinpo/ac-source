...
<div class="row">
        ...
        <?php if ($model->isNewRecord): ?>
            <?php
            echo CHtml::dropDownList('parent_id', '', ProductSaleCategoryList::getOptions(), array('size' => 7,'style' => 'width: 250px'));
            ?>

        <?php else: ?>
    
            <?php
            $category = ProductSaleCategoryList::model()->findByPk($model->id);
            ...
            echo CHtml::dropDownList('parent_id', $select, ProductSaleCategoryList::getOptions($model->id, $children), array('size' => 7,'style' => 'width: 250px'));
            ?>
 ...
 <div class="row">
        ...
        <?php else: ?>
            ...
            <?php
               echo CHtml::dropDownList('order_id', $model->id, ProductSaleCategoryList::getSiblings($model->id, false));
            ?>
...
CopyString('#ProductSaleCategoryList_name','#ProductSaleCategoryList_slug','slug');
</script>
<?php endif; ?>