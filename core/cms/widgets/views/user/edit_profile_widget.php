<div class="form">
    ...
    <div class="row clearfix">
        ...
        <?php echo $form->radioButtonList($model, 'gender', array('male' => t('cms', 'Male'), 'female' => t('cms', 'Female')), array('separator' => '', 'class' => 'radio_btn')); ?>
    ...
    <div class="row">
         <label for="region_id"><?php echo t('cms', 'Province'); ?></label>	 
