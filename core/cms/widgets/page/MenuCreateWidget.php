...
class MenuCreateWidget extends CWidget
{
    ...
    {       
        ...
        if(isset($_POST['Menu']))
        {
                ...
                if($model->save()){
                    $menuItemRoot = new MenuItems;
                    $menuItemRoot->name = 'root-menu-'.$model->menu_id;
                    $menuItemRoot->menu_id = $model->menu_id;
                    $menuItemRoot->saveNode(false);
                    user()->setFlash('success',Yii::t('AdminPage','Create new Menu Successfully!'));                                                            
                    $model=new Menu;
